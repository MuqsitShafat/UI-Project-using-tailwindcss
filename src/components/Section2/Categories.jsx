    ...
    <div className='h-[90%] w-full flex flex-col mt-30'>
      ...
      <div ref={containerRef} className='ml-3 grid grid-cols-6 gap-5 place-items-center'>
        <div className='category-item flex flex-col justify-center items-center rounded-2xl'>
          <img src='src/assets/images/Special.png' className='drop-shadow-lg rounded-full cursor-pointer' />
          <p className='font-space-bold text-lg'>Special</p>
        </div>
        <div className='category-item flex flex-col justify-center items-center rounded-2xl'>
          <img src='src/assets/images/Donut.png' className='drop-shadow-lg rounded-full cursor-pointer' />
          <p className='font-space-bold text-lg'>DoughNuts</p>
        </div>
        <div className='category-item flex flex-col justify-center items-center rounded-2xl'>
          <img src='src/assets/images/Cookie.png' className='drop-shadow-lg rounded-full cursor-pointer' />
          <p className='font-space-bold text-lg'>Cookies</p>
        </div>
        <div className='category-item flex flex-col justify-center items-center rounded-2xl'>
          <img src='src/assets/images/Cake.png' className='drop-shadow-lg rounded-full cursor-pointer' />
          <p className='font-space-bold text-lg'>Cakes</p>
        </div>
        <div className='category-item flex flex-col justify-center items-center rounded-2xl'>
          <img src='src/assets/images/Bread.png' className='drop-shadow-lg rounded-full cursor-pointer' />
