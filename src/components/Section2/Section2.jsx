...
const Section2 = () => {
  return (
    <div className='h-[90%] w-full flex flex-col mt-30 p-10'>
      <div className='bg-[#dfc198] py-2 px-6 w-fit rounded-tl-[40%] rounded-br-[35%] rounded-bl-[5%] '>
        <h1 className='text-4xl font-space-semi-bold'>Categories</h1>
      </div>
